...
const Experience = () => {
    ...
    const items = [{
        ...
        cardTitle: <div><img className="max-w-xs max-h-12" src={`${basePath}/${workExperience[0].thumbnail}`} alt="thumbnail" /></div>,
        ...
        cardTitle: <div><img className="max-w-xs max-h-14" src={`${basePath}/${workExperience[1].thumbnail}`} alt="thumbnail" /></div>,
